...
echo ""
loading "UPDATING CONFIG FILES"

# ==============================================
# ✅ XRAY CONFIG – XHTTP ERROR FIXED • HTTPUPGRADE NANATILI
# ==============================================
cat > config.json <<'EOF'
{
...
# ==============================================
# ✅ NGINX CONFIG – XHTTP OPTIMIZED • WALANG IBANG BINAGO
# ==============================================
cat > nginx.conf <<'EOF'
worker_processes 1;
